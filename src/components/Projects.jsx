    ...
    >
      <div className="container mx-auto max-w-7xl">
                  ...
                  <div className="h-full">
                    <Card className="h-full flex flex-col overflow-hidden group hover:shadow-2xl transition-all duration-300 active:scale-95 sm:hover:scale-[1.02] border-2 hover:border-primary/50">
                      ...
                      <div className="relative h-44 sm:h-48 overflow-hidden bg-muted">
                        ...
                        {/* Category Badge */}
                        <Badge className="absolute top-2 sm:top-3 right-2 sm:right-3 bg-primary/90 backdrop-blur-sm text-xs">
                          {project.category}
                        </Badge>
                      </div>
                      ...
                      <CardHeader className="pb-2 sm:pb-3 px-4 sm:px-6 pt-4 sm:pt-6">
                        <CardTitle className="text-lg sm:text-xl font-bold line-clamp-1 group-hover:text-primary transition-colors">
                          {project.title}
                        </CardTitle>
                        <CardDescription className="text-xs sm:text-sm line-clamp-3 sm:line-clamp-none">
                          {project.description}
                        </CardDescription>
                      </CardHeader>

                      <CardContent className="grow px-4 sm:px-6">
                      ...
                      <CardFooter className="pt-0 px-4 sm:px-6 pb-4 sm:pb-6">
                        <Button
                          variant="ghost"
                          className="w-full h-10 sm:h-9 group-hover:bg-accent transition-colors text-sm"
                          onClick={() =>
        ...
        <div className="flex justify-center mt-6 sm:mt-8 gap-2 items-center">
          <p className="text-xs sm:text-sm text-muted-foreground md:hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 inline ml-1 animate-pulse"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
